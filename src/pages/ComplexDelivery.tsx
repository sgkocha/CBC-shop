...
const ComplexDelivery = () => {
    return (
        <main>
            ...
            <section>
                <div className="cbc-selection">
                    <div className="container d-f jc-sb align-center">
                        <div className="cbc-selection-img"><img src="images/selection.png" alt="selection" /></div>
                        <div className="cbc-selection-img"><img src="images/office.png" alt="office" /></div>
                        <div className="cbc-selection-about">
                            <div className="cbc-selection-title">Need new computers?</div>
                            <div className="cbc-selection-subtitle">We have been implementing solutions for companies in Newark for 28 years</div>
                            <button className="cbc-request-btn">leave a request</button>
                        </div>
                    </div>
                </div>
            ...
            <section>
                <div className="cbc-consultation">
                    <div className="container">
                        <div className="cbc-consultation-title" style={{ width: "578px", margin: "0 auto" }}>Would you like a free consultation
                            turnkey computer equipment?</div>
